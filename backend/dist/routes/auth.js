...
router.get('/google/callback', async (req, res) => {
    ...
    const state = req.query.state; // Assuming state contains { userId }
...
router.get('/zoom', auth_1.authenticate, auth_1.extractUserInfo, (req, res) => {
    ...
    const authUrl = (0, zoomAuthService_1.getZoomAuthorizationUrl)(state);
...
router.get('/zoom/callback', /* authenticate, extractUserInfo, */ async (req, res) => {
    ...
    try {
        ...
        const tokens = await (0, zoomAuthService_1.exchangeCodeForZoomTokens)(code);
        await (0, zoomAuthService_1.saveZoomTokens)(userId, tokens); // Use userId obtained from state
